    ...
    <div className="max-w-6xl mx-auto space-y-32">
      {projects.map((project, index) => (
        ...
        >
          ...
          <div className="flex flex-1 flex-col justify-center gap-4 lg:px-8">
            <span className="inline-block rounded-full bg-orange-100 px-4 py-1.5 text-sm font-medium text-orange-600 dark:bg-orange-500/10 dark:text-orange-500">
              {project.category}
            </span>
